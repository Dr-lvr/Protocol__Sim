...
public class SwingAnimator {
     ...
     * Constructs a new animation.SwingAnimator.
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if ( callback.hasTerminated() ){
                ...
                if ( timer == null ){
                    ...
                    throw new IllegalStateException("Callback listener should not be fired outside of animation.SwingAnimator timer control");
